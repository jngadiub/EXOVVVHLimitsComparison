...
##################################################################################
obs_lim = {'1000': 0.058634, '1500': 0.035008, '2000': 0.028438}
max_width = 0.05
model = 'B3'
#model = 'A1'
#model = 'A3'
...
##################################################################################   
colors = {'1000':kAzure+1,'1500':kViolet+7,'2000':kBlack}
linestyle = {'1000':1,'1500':1,'2000':1}
lim_text_pos = {'1000':[0.52,0.47,0.60,0.55],'1500':[0.69,0.32,0.75,0.39],'2000':[0.75,0.66,0.81,0.73]}
lim_extra_text = {'1000':'1 TeV','1500':'1.5 TeV','2000':'2 TeV'}
models_text_pos = {'A1':[0.49,0.34,0.55,0.41],'A3':[0.46,0.48,0.52,0.55],'B3':[0.14,0.50,0.20,0.57]}
...
width_text_pos = [0.15,0.16,0.31,0.23]
